...
class EmojiGame extends Component {
  ...
  gameCompleteAndUpdateTopScore = clickedEmojisList => {
  ...
  clickedEmoji = id => {
    ...
    if (isEmojiPresent) {
      this.gameCompleteAndUpdateTopScore(clickedEmojisList)
    } else {
  ...
  resetWinGame = () => {
    this.setState({clickedEmojisList: [], gameInProgress: true, topScore: 0})
  }
